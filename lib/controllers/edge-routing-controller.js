...
export class EdgeRoutingController {
  ...
  /** @type {HTMLElement} */ #edgeLayer;
  /** @type {string} */ #nodeSelector;
  /** @type {string} */ #portSelector;
  /** @type {boolean} */ #isRouting = false;
  /** @type {string | null} */ #sourcePortId = null;
  /** @type {string | null} */ #sourceNodeId = null;
  /** @type {SVGPathElement | null} */ #phantomPath = null;
  /** @type {{ x: number, y: number } | null} */ #sourcePos = null;
