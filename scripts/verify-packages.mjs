 ...
 * published — `@nodeweave/core` from its root (files allowlist), the Angular
...
const PACKAGES = [
  { name: '@nodeweave/core', packDir: 'packages/core' },
  { name: '@nodeweave/angular', packDir: 'packages/angular/dist' },
  { name: '@nodeweave/angular-authoring', packDir: 'packages/angular-authoring/dist' },
];
