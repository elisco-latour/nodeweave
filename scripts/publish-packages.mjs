 ...
 *
 * Publishes each package's real artifact — `@nodeweave/core` from its root, the
...
const PACKAGES = [
  { name: '@nodeweave/core', dir: 'packages/core' },
  { name: '@nodeweave/angular', dir: 'packages/angular/dist' },
  { name: '@nodeweave/angular-authoring', dir: 'packages/angular-authoring/dist' },
];
