...
import type { SchemaDefinition, SchemaField, VisualCanvasService } from '@build744/nodeweave-angular';
import { NodeCatalog, type NodeTypeDefinition } from '@build744/nodeweave-angular-authoring';
